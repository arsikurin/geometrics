...
type User struct {
	...
	LastOnline time.Time   `boil:"last_online" json:"last_online" toml:"last_online" yaml:"last_online"`
...
var UserWhere = struct {
	...
	LastOnline whereHelpertime_Time
	...
	Grade:      whereHelpernull_Int{field: "\"users\".\"grade\""},
	School:     whereHelpernull_String{field: "\"users\".\"school\""},
	CreatedAt:  whereHelpertime_Time{field: "\"users\".\"created_at\""},
	LastOnline: whereHelpertime_Time{field: "\"users\".\"last_online\""},
	Timezone:   whereHelperstring{field: "\"users\".\"timezone\""},
}

// UserRels is where relationship names are stored.
var UserRels = struct {
	AuthorCourses string
	Submits       string
}{
...
type userR struct {
	AuthorCourses CourseSlice `boil:"AuthorCourses" json:"AuthorCourses" toml:"AuthorCourses" yaml:"AuthorCourses"`
...
func (r *userR) GetAuthorCourses() CourseSlice {
	if r == nil {
		return nil
	}
	return r.AuthorCourses
}

func (r *userR) GetSubmits() SubmitSlice {
	if r == nil {
		return nil
	}
	return r.Submits
...
var (
	userAllColumns            = []string{"id", "login", "password", "type", "first_name", "last_name", "grade", "school", "created_at", "last_online", "timezone"}
	userColumnsWithoutDefault = []string{"login", "password", "first_name", "last_name", "last_online"}
	userColumnsWithDefault    = []string{"id", "type", "grade", "school", "created_at", "timezone"}
...
// AuthorCourses retrieves all the course's Courses with an executor via author_id column.
func (o *User) AuthorCourses(mods ...qm.QueryMod) courseQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"courses\".\"author_id\"=?", o.ID),
	)
...
func (o *User) Submits(mods ...qm.QueryMod) submitQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"submits\".\"user_id\"=?", o.ID),
	)

	return Submits(queryMods...)
}

// LoadAuthorCourses allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadAuthorCourses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`courses`),
		qm.WhereIn(`courses.author_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.AuthorCourses = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.AuthorID {
				local.R.AuthorCourses = append(local.R.AuthorCourses, foreign)
				if foreign.R == nil {
					foreign.R = &courseR{}
				}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadSubmits(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`submits`),
		qm.WhereIn(`submits.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// AddAuthorCoursesG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.AuthorCourses.
// Sets related.R.Author appropriately.
// Uses the global database handle.
func (o *User) AddAuthorCoursesG(ctx context.Context, insert bool, related ...*Course) error {
	return o.AddAuthorCourses(ctx, boil.GetContextDB(), insert, related...)
}

// AddAuthorCourses adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.AuthorCourses.
// Sets related.R.Author appropriately.
func (o *User) AddAuthorCourses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Course) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			AuthorCourses: related,
		}
	} else {
		o.R.AuthorCourses = append(o.R.AuthorCourses, related...)
	}
...
// Uses the global database handle.
func (o *User) AddSubmitsG(ctx context.Context, insert bool, related ...*Submit) error {
...
// Appends related to o.R.Submits.
// Sets related.R.User appropriately.
func (o *User) AddSubmits(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Submit) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
