...
var (
	...
	userColumnsWithoutDefault = []string{"login", "password", "first_name", "last_name"}
	userColumnsWithDefault    = []string{"id", "type", "grade", "school", "created_at", "last_online", "timezone"}
